...
export default function CreatePost({ showModal, setShowModal }) {
            ...
            <form onSubmit={handleUpload}>
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg leading-6 font-medium text-gray-900 mb-2">Upload Post</h3>
              ...
              <div className="w-[63%] ml-[80px]">
                <textarea
                  ...
                  value={captionText}
                  name="caption"
                  className="border border-black w-[100%] p-2 text-md font-semibold ml-[1px]"
                ></textarea>
              </div>
